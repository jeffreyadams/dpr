...
Kostant showed \cite{kostant} that the Kostant section meets every regular orbit in a unique point. If the tripple lies in $\g(\R)$, then $\K(X)$ is Galois stable. The Kostant section $\K(X)$ depends on a choice of
