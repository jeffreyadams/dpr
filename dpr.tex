...
\warn{Note: this is the set $\Omega_\Xi=a^{-1}\Omega\cap \Xi'$ of \cite[Lemma 18]{HC_inv_eigen} where $\Xi$ is our $T$ and
 $\Xi'=\Xi'(a)$ is defined on page 462. 
That definition says $\Xi'(a)=a^{-1}(\Xi\cap G')$. In our notation this gives 
$U_T=a^{-1}U_G \cap a^{-1}T'=a^{-1}(U_G\cap T')$, and this equals $a^{-1}(U_G\cap T)$ since $U_G\subset G'$}
